//*************************************************************************
//	创建日期:	2014-12-12
//	文件名称:	Test_Action_TreeFadeOut.h
//  创 建 人:   WilhanTian	
//	版权所有:	MIT
//	说    明:	渐显节点树，渐显该节点的所有子节点
//  测试结果: 
//*************************************************************************
...
public:
	virtual bool init()
	{
		...
		CCLabelTTF* lable = CCLabelTTF::create(FKCW_Base_StringConvert::a2u("点我对精灵A执行渐隐动作").c_str(), "Arial", 26 );
...
//-------------------------------------------------------------------------
CREATE_TEST_SCENE_CLASS(Action, TreeFadeOut, 渐隐节点树，渐隐该节点的所有子节点（A是根节点、B的父节点是A、C的父节点是B）)
//-------------------------------------------------------------------------