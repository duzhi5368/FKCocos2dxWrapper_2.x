...
FKCW_UIWidget_Scale9Sprite::FKCW_UIWidget_Scale9Sprite()
: m_insetLeft(0)
, m_insetTop(0)
, m_insetRight(0)
, m_insetBottom(0)
...
bool FKCW_UIWidget_Scale9Sprite::init()
{
    return this->initWithBatchNode(NULL, CCRectZero, CCRectZero);
}

bool FKCW_UIWidget_Scale9Sprite::initWithBatchNode(CCSpriteBatchNode* batchnode, CCRect rect, CCRect capInsets)
{
    return this->initWithBatchNode(batchnode, rect, false, capInsets);
}

bool FKCW_UIWidget_Scale9Sprite::initWithBatchNode(CCSpriteBatchNode* batchnode, CCRect rect, bool rotated, CCRect capInsets)
{
    if(batchnode)
    {
...
bool FKCW_UIWidget_Scale9Sprite::updateWithBatchNode(CCSpriteBatchNode* batchnode, CCRect rect, bool rotated, CCRect capInsets)
{
...
void FKCW_UIWidget_Scale9Sprite::setContentSize(const CCSize &size)
{
    CCNode::setContentSize(size);
    this->m_positionsAreDirty = true;
}

void FKCW_UIWidget_Scale9Sprite::updatePositions()
{
...
bool FKCW_UIWidget_Scale9Sprite::initWithFile(const char* file, CCRect rect,  CCRect capInsets)
{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::create(const char* file, CCRect rect,  CCRect capInsets)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithFile(const char* file, CCRect rect)
{
    CCAssert(file != NULL, "Invalid file for sprite");
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::create(const char* file, CCRect rect)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithFile(CCRect capInsets, const char* file)
{
    bool pReturn = this->initWithFile(file, CCRectZero, capInsets);
    return pReturn;
}

FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::create(CCRect capInsets, const char* file)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithFile(const char* file)
{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::create(const char* file)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithSpriteFrame(CCSpriteFrame* spriteFrame, CCRect capInsets)
{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithSpriteFrame(CCSpriteFrame* spriteFrame, CCRect capInsets)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithSpriteFrame(CCSpriteFrame* spriteFrame)
{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithSpriteFrame(CCSpriteFrame* spriteFrame)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithSpriteFrameName(const char* spriteFrameName, CCRect capInsets)
{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithSpriteFrameName(const char* spriteFrameName, CCRect capInsets)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
bool FKCW_UIWidget_Scale9Sprite::initWithSpriteFrameName(const char* spriteFrameName)
{
    bool pReturn = this->initWithSpriteFrameName(spriteFrameName, CCRectZero);
    return pReturn;
}

FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithSpriteFrameName(const char* spriteFrameName)
{
    ...
    CCLog("Could not allocate FKCW_UIWidget_Scale9Sprite()");
    return NULL;
}

bool FKCW_UIWidget_Scale9Sprite::initWithTexture(CCTexture2D* pTexture)
{
	return initWithTexture(pTexture, CCRectZero);
}

bool FKCW_UIWidget_Scale9Sprite::initWithTexture(CCTexture2D* pTexture, CCRect capInsets)
{
	if( pTexture )
	{
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithTexture(CCTexture2D* pTexture)
{
	FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::createWithTexture(CCTexture2D* pTexture, CCRect capInsets)
{
	FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
void FKCW_UIWidget_Scale9Sprite::setTexture(CCTexture2D* pTexture)
{
	if( pTexture )
	{
		CCSpriteBatchNode *batchnode = CCSpriteBatchNode::createWithTexture(pTexture, 9);
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::resizableSpriteWithCapInsets(CCRect capInsets)
{
    FKCW_UIWidget_Scale9Sprite* pReturn = new FKCW_UIWidget_Scale9Sprite();
...
FKCW_UIWidget_Scale9Sprite* FKCW_UIWidget_Scale9Sprite::create()
{ 
    FKCW_UIWidget_Scale9Sprite *pReturn = new FKCW_UIWidget_Scale9Sprite();
...
void FKCW_UIWidget_Scale9Sprite::setPreferredSize(CCSize preferedSize)
{
    this->setContentSize(preferedSize);
    this->m_preferredSize = preferedSize;
}

CCSize FKCW_UIWidget_Scale9Sprite::getPreferredSize()
{
    return this->m_preferredSize;
}

void FKCW_UIWidget_Scale9Sprite::setCapInsets(CCRect capInsets)
{
    if (!_scale9Image)
    {
        return;
...
CCRect FKCW_UIWidget_Scale9Sprite::getCapInsets()
{
    return m_capInsets;
}

void FKCW_UIWidget_Scale9Sprite::updateCapInset()
{
    CCRect insets;
...
void FKCW_UIWidget_Scale9Sprite::setOpacityModifyRGB(bool var)
{
    if (!_scale9Image)
    {
        return;
...
bool FKCW_UIWidget_Scale9Sprite::isOpacityModifyRGB()
{
    return _opacityModifyRGB;
}

void FKCW_UIWidget_Scale9Sprite::updateDisplayedOpacity(GLubyte parentOpacity)
{
    CCNodeRGBA::updateDisplayedOpacity(parentOpacity);
    setOpacity(parentOpacity);
}

void FKCW_UIWidget_Scale9Sprite::updateDisplayedColor(const cocos2d::ccColor3B &color)
{
    CCNodeRGBA::updateDisplayedColor(color);
    setColor(color);
}

void FKCW_UIWidget_Scale9Sprite::setSpriteFrame(CCSpriteFrame * spriteFrame)
{
...
float FKCW_UIWidget_Scale9Sprite::getInsetLeft()
{
    return this->m_insetLeft;
}

float FKCW_UIWidget_Scale9Sprite::getInsetTop()
{
    return this->m_insetTop;
}

float FKCW_UIWidget_Scale9Sprite::getInsetRight()
{
    return this->m_insetRight;
}

float FKCW_UIWidget_Scale9Sprite::getInsetBottom()
{
    return this->m_insetBottom;
}

void FKCW_UIWidget_Scale9Sprite::setInsetLeft(float insetLeft)
{
    this->m_insetLeft = insetLeft;
    this->updateCapInset();
}

void FKCW_UIWidget_Scale9Sprite::setInsetTop(float insetTop)
{
    this->m_insetTop = insetTop;
    this->updateCapInset();
}

void FKCW_UIWidget_Scale9Sprite::setInsetRight(float insetRight)
{
    this->m_insetRight = insetRight;
    this->updateCapInset();
}

void FKCW_UIWidget_Scale9Sprite::setInsetBottom(float insetBottom)
{
    this->m_insetBottom = insetBottom;
    this->updateCapInset();
}

void FKCW_UIWidget_Scale9Sprite::visit()
{
...
void FKCW_UIWidget_Scale9Sprite::setColor(const ccColor3B& color)
{
    if (!_scale9Image)
    {
        return;
...
const ccColor3B& FKCW_UIWidget_Scale9Sprite::getColor()
{
	return _color;
}

void FKCW_UIWidget_Scale9Sprite::setOpacity(GLubyte opacity)
{
    if (!_scale9Image)
    {
        return;
...
GLubyte FKCW_UIWidget_Scale9Sprite::getOpacity()
{
	return _opacity;
}
